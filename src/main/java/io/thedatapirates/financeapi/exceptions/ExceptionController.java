...
public class ExceptionController {
  ...
  protected ResponseEntity<ExceptionResponseMessage> serverUnavailable(
    ...
    ExceptionResponseMessage response = new ExceptionResponseMessage(errors, new Date(),
        StringConstants.SERVICE_UNAVAILABLE);
  ...
  protected ResponseEntity<ExceptionResponseMessage> validationException(
