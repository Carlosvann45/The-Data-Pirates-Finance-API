...
public class InvestmentServiceImpl implements InvestmentService{
     ...
     * investments based on that customers id
     *
    ...
    public Investment createInvestmentForCustomer(String token, Investment newInvestment) {
        ...
        if (existingInvestment != null) throw new Conflict(StringConstants.INVESTMENT_NAME_CONFLICT);
     ...
     */
    @Override
    public Investment updateInvestmentForCustomer(String token, Long investmentId, Investment updatedInvestment) {
        Investment existingInvestment;
