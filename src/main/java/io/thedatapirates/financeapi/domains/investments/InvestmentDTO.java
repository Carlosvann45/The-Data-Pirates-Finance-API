...
public class InvestmentDTO extends BaseEntityDTO {
    ...
    public InvestmentDTO(Date dateCreated, Date dateUpdated, String investmentType, String name, double amount, double buyPrice) {
    ...
    public InvestmentDTO(Long id, Date dateCreated, Date dateUpdated, String investmentType, String name, double amount, double buyPrice) {
