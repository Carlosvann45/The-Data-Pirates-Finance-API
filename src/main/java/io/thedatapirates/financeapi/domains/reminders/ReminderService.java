...
public interface ReminderService {
    ...
    Reminder createReminderForCustomer(String token, Long frequencyId, Reminder newReminder);

    Reminder updateReminderForCustomer(String token, Long frequencyId, Long reminderId, Reminder updatedReminder);
