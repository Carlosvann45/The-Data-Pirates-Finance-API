...
public interface ReminderService {
    ...
    Reminder createReminderForCustomer(String token, Long frequencyId, Long expenseId, Reminder newReminder);

    Reminder updateReminderForCustomer(String token, Long frequencyId, Long reminderId, Long expenseId, Reminder updatedReminder);
