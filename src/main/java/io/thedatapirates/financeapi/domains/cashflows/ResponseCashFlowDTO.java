...
public class ResponseCashFlowDTO extends BaseEntityDTO {
    ...
    public ResponseCashFlowDTO(Date dateCreated, Date dateUpdated, String name, double amount, FrequencyDTO frequency) {
    ...
    public ResponseCashFlowDTO(Long id, Date dateCreated, Date dateUpdated, String name, double amount, FrequencyDTO frequency) {
