...
public class CashFlowServiceImpl implements CashFlowService{
    ...
    public CashFlow createCashFlowForCustomer(String token, Long frequencyId, CashFlow newCashFlowItem) {
        ...
        else if (existingFrequency == null) throw new BadRequest(StringConstants.CASH_FLOW_BAD_FREQUENCY);
     ...
     * @param cashFlowId cash flow if for cash flow to update
    ...
    public CashFlow updateCashFlowForCustomer(String token, Long frequencyId, Long cashFlowId, CashFlow updatedCashFlowItem) {
        ...
        else if (existingName != null) throw new Conflict(StringConstants.CASH_FLOW_NAME_CONFLICT);
        else if (existingFrequency == null) throw new BadRequest(StringConstants.CASH_FLOW_BAD_FREQUENCY);
