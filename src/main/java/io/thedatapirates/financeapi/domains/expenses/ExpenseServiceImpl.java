...
public class ExpenseServiceImpl implements ExpenseService {
     ...
     * expenses based on that customers id
     *
    ...
    /**
     * Creates a new expense for a customer if frequency and customer
    ...
    public Expense createExpenseForCustomer(
        ...
        if (existingExpense != null) throw new Conflict(StringConstants.EXPENSE_NAME_CONFLICT);
        else if (existingCategory == null) throw new BadRequest(StringConstants.BAD_CATEGORY);
        else if (existingFrequency == null) throw new BadRequest(StringConstants.BAD_FREQUENCY);
        else if (existingPriorityLevel == null) throw new BadRequest(StringConstants.BAD_PRIORITY_LEVEL);
    ...
    public Expense updateExpenseForCustomer(
        ...
        if (existingExpense == null) throw new NotFound(StringConstants.EXPENSE_NOT_FOUND);
    ...
    public void deleteExpenseForCustomer(String token, Long expenseId) {
        ...
        if (existingExpense == null) throw new NotFound(StringConstants.EXPENSE_NOT_FOUND);
        else if (!existingCustomer.getExpenses().contains(existingExpense)) throw new BadRequest(
